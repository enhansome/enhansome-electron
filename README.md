...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 191,447 | 🐛 20,673 | 🌐 TypeScript | 📅 2026-09-07 - Cross-platform IDE.
...
* [Min](https://github.com/minbrowser/min) ⭐ 9,168 | 🐛 605 | 🌐 JavaScript | 📅 2026-08-30 - Minimal web browser.

###### Other

* [Mark Text](https://github.com/marktext/marktext) ⭐ 61,140 | 🐛 722 | 🌐 TypeScript | 📅 2026-09-07 - Real-time preview Markdown editor.
* [Motrix](https://github.com/agalwood/Motrix) ⭐ 55,320 | 🐛 128 | 🌐 TypeScript | 📅 2026-09-07 - Download manager.
* [LosslessCut](https://github.com/mifi/lossless-cut) ⭐ 43,541 | 🐛 298 | 🌐 TypeScript | 📅 2026-09-07 - Lossless video trimming & cutting.
* [Insomnia](https://github.com/getinsomnia/insomnia) ⭐ 39,998 | 🐛 873 | 🌐 TypeScript | 📅 2026-09-07 - Create and manage HTTP requests.
* [Etcher](https://github.com/resin-io/etcher) ⭐ 34,313 | 🐛 690 | 🌐 TypeScript | 📅 2026-06-02 - Flash OS images to SD cards and USB drives.
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,447 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-06 - Visualizer for deep learning and machine learning models.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 23,562 | 🐛 1,163 | 🌐 TypeScript | 📅 2026-09-07 - Cross-platform SQL editor and database manager.
* [Notable](https://github.com/fabiospampinato/notable) ⭐ 23,500 | 🐛 732 | 📅 2024-06-21 - Markdown-based note-taking.
* [Wave Terminal](https://github.com/wavetermdev/waveterm) ⭐ 22,233 | 🐛 568 | 🌐 Go | 📅 2026-09-03 - Open-source terminal with AI integration.
* [Kap](https://github.com/wulkano/kap) ⭐ 19,350 | 🐛 256 | 🌐 TypeScript | 📅 2024-11-12 - Screen recorder with GIF support.
* [Nuclear](https://github.com/nukeop/nuclear) ⭐ 18,408 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-07 - Music player that streams from free sources.
* [Mailspring](https://github.com/Foundry376/Mailspring) ⭐ 17,778 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-07 - Extensible email client. (Fork of Nylas Mail)
* [Boostnote](https://github.com/BoostIO/Boostnote) ⚠️ Archived - Markdown note & code snippet app for developers.
* [Signal Desktop](https://github.com/signalapp/Signal-Desktop) ⭐ 16,521 | 🐛 890 | 🌐 TypeScript | 📅 2026-09-07 - Companion desktop app for Signal mobile app.
* [KeeWeb](https://github.com/keeweb/keeweb) ⭐ 12,992 | 🐛 441 | 🌐 HTML | 📅 2026-05-08 - Unofficial KeePass app.
* [Heroic Games Launcher](https://github.com/Heroic-Games-Launcher/HeroicGamesLauncher) ⭐ 12,162 | 🐛 902 | 🌐 TypeScript | 📅 2026-09-07 - Alternative Epic games launcher.
...
* [Cerebro](https://github.com/KELiON/cerebro) ⭐ 8,558 | 🐛 77 | 🌐 JavaScript | 📅 2026-09-07 - Launcher with inline previews.
...
* [Sigma File Manager](https://github.com/aleksey-hoffman/sigma-file-manager) ⭐ 6,520 | 🐛 208 | 🌐 TypeScript | 📅 2026-08-27 - Modern file manager.
* [Pomotroid](https://github.com/Splode/pomotroid) ⭐ 5,480 | 🐛 128 | 🌐 Rust | 📅 2026-08-02 - Pomodoro timer.
* [Gitify](https://github.com/manosim/gitify) ⭐ 5,341 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-07 - GitHub notifications in your menubar.
...
* [Sabaki](https://github.com/SabakiHQ/Sabaki) ⭐ 2,771 | 🐛 115 | 🌐 JavaScript | 📅 2026-09-07 - Go/Baduk/Weiqi board.
* [ExifCleaner](https://github.com/szTheory/exifcleaner) ⭐ 2,671 | 🐛 41 | 🌐 Perl | 📅 2026-09-07 - Clean image metadata with drag and drop.
* [Abricotine](https://github.com/brrd/Abricotine) ⚠️ Archived - Markdown editor with inline preview.
* [Mattermost](https://github.com/mattermost/desktop) ⭐ 2,269 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-07 - Mattermost client.
...
* [Wire](https://github.com/wireapp/wire-desktop) ⭐ 1,129 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-07 - Messenger and calling app.
...
* [electron-quick-start](https://github.com/electron/electron-quick-start) ⭐ 11,447 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-01 - Clone the repo to try a simple app.
...
* [RxDB](https://github.com/pubkey/rxdb) ⭐ 23,374 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-07 - A realtime NoSQL database.
* [got](https://github.com/sindresorhus/got) ⭐ 14,944 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - Simplified HTTP requests.
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,659 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-07 - Create installers.
* [NeDB](https://github.com/louischatriot/nedb) ⭐ 13,533 | 🐛 209 | 🌐 JavaScript | 📅 2025-05-15 - Embedded persistent or in-memory database.
* [electron-vite](https://github.com/alex8088/electron-vite) ⭐ 5,600 | 🐛 89 | 🌐 TypeScript | 📅 2026-08-18 - Fast and easy-to-use build tool integrated with Vite.
...
* [adblocker-electron](https://github.com/cliqz-oss/adblocker/tree/master/packages/adblocker-electron) ⭐ 1,000 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-07 - Block ads and trackers.
...
* [awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,726 | 🐛 25 | 📅 2026-09-02
